...
![Werkschema overzichtspagina](werkschema_pagina.png ':size=700 :class=center-image')
...
![Wisselen tussen agenda's](werkschema_wisselen_agenda.png ':size=200 :class=center-image')
...
![Werkschema kopiëren](werkschema_kopieren.png ':size=500 :class=center-image')
...
![Werkschema verwijderen](werkschema_verwijderen.png ':size=500 :class=center-image')
...
![Week verwijderen](werkschema_week_verwijderen.png ':size=500 :class=center-image')
...
![Popover invoeren](werkschema_invoeren_popover.png ':size=400 :class=center-image')

Klik op **Invoeren** om het dialoogvenster te openen.

![Beschikbaarheid toevoegen](werkschema_invoeren_popup.png ':size=400 :class=center-image')
...
![Popover wijzigen](werkschema_wijzigen_popover.png ':size=400 :class=center-image')

Klik op **Wijzigen** om het dialoogvenster te openen.

![Beschikbaarheid wijzigen](werkschema_wijzigen_popup.png ':size=400 :class=center-image')
...
![Dag kopiëren](werkschema_dag_kopieren.png ':size=500 :class=center-image')
...
![Dag verwijderen](werkschema_dag_verwijderen.png ':size=500 :class=center-image')
