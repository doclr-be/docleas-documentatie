...
![Taalkeuze](taalkeuze.png ':size=400 :class=center-image')
...
![Product keuze](product_keuze_start.png ':size=400 :class=center-image')

Als de burger een **groepstegeltje** kiest dan worden alle producten van deze groep getoond.

![Product keuze van een groep](product_keuze_groep.png ':size=400 :class=center-image')
...
![Product overzicht](product_keuze_overzicht.png ':size=400 :class=center-image')
...
**Configuratie**
- [Producten beheren](../dienstbeheerders/producten/producten-beheren.md) - Producten aanmaken en beheren
- [Productgroepen](../dienstbeheerders/producten/groepen.md) - Producten organiseren in groepen
- [Overzichtspagina](../dienstbeheerders/producten/overzichtspagina.md) - Alle producten beheren in één overzicht
...
**Configuratie**
- [Teksten beheren](../dienstbeheerders/producten/teksten.md) - Uitleg over het beheren van teksten
...
**Configuratie**
- Locaties worden beheerd via [Agenda's](../dienstbeheerders/agendas.md).
...
![Tijdskeuze](tijdskeuze.png ':size=400 :class=center-image')
...
![Gegevens van de burger](gegevens.png ':size=400 :class=center-image')

**Configuratie**
- Configureer de velden via [Producten - Velden](../dienstbeheerders/producten/velden.md).
...
![Bevestigen van de afspraak](bevestigen.png ':size=400 :class=center-image')


**Configuratie**
De inhoud van de bevestigingsmail stel je in via [Gemeente-instellingen](../dienstbeheerders/gemeente-instellingen.md).
...
| Stap | Configuratie |
|------|-------------|
| Taalkeuze | [Gemeente-instellingen](../dienstbeheerders/gemeente-instellingen.md) |
